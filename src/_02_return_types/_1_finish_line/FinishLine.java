...
public class FinishLine {
	...
	public static void main(String[] args) {
		...
		//5. If the robot has crossed the finish line... 
			if (finish = true) {
				JOptionPane.showMessageDialog (null, "Your robot has finished, it went this far:" +distance);
			}
			else
				JOptionPane.showMessageDialog (null, "Your robot didn't finish, it went this far:" +distance);
